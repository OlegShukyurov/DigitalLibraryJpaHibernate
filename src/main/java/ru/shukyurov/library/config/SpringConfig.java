package ru.shukyurov.library.config;
...
@ComponentScan("ru.shukyurov.library")
@EnableTransactionManagement
@EnableJpaRepositories("ru.shukyurov.library.repositories")
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("ru.shukyurov.library.models");
